...
class Player
{
  public:
    ...
    //Will remove the pair from the hand after populating the given card variables
    ...
    //Pre-condition: Player has the card in their hand
    Card removeCardFromHand(Card c);

    //Remove card of same rank as c from hand and return it
    //Pre-condition: Player has the card in their hand
